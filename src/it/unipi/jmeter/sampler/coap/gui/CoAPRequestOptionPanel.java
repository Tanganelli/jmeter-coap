...
public class CoAPRequestOptionPanel extends JPanel {
	...
	public void setEnabled(boolean enabled){
		...
		txtETag.setEnabled(enabled);
		txtIfMatch.setEnabled(enabled);
		txtUriHost.setEnabled(enabled);
		txtObserve.setEnabled(enabled);
		txtUriPort.setEnabled(enabled);
		txtProxyUri.setEnabled(enabled);
		cmbAccept.setEnabled(enabled);
		cmbContentFormat.setEnabled(enabled);
		chkIfNoneMatch.setEnabled(enabled);
		chkProxySchema.setEnabled(enabled);
	}
}
